...
# Window manager not needed for web player
# Chromium will handle fullscreen mode
echo "Started on-screen keyboard (PID: $KEYBOARD_PID)" >> /tmp/spotify-touch.log

# Start the web-based Spotify player
echo "Starting Spotify web player..." >> /tmp/spotify-touch.log

# Launch the web player
/opt/spotify-terminal/scripts/start-web-player.sh &
